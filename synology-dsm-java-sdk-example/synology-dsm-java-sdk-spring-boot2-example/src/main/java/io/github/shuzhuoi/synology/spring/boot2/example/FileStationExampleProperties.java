...
public class FileStationExampleProperties {
    ...
    public FileStationBasicWorkflowConfig toWorkflowConfig() {
        return new FileStationBasicWorkflowConfig(
                new File(required(sampleFile, "sample-file")),
                required(remoteFolder, "remote-folder"),
                new File(required(downloadFolder, "download-folder")));
    }
