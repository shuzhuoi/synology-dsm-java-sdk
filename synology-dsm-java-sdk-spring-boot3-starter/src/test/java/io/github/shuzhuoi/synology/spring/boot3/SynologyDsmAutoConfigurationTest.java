...
/**
 * Spring Boot 3 Starter 自动装配测试，使用 ApplicationContextRunner 验证装配与条件回退行为。
 */
class SynologyDsmAutoConfigurationTest {
    ...
    /**
     * AutoConfiguration.imports 必须注册自动配置类，保证真实应用引入 Starter 即生效。
     */
    @Test
    void shouldRegisterAutoConfigurationInImportsFile() throws IOException {
        assertTrue(classpathResourceContains(
                "META-INF/spring/org.springframework.boot.autoconfigure.AutoConfiguration.imports",
                "io.github.shuzhuoi.synology.spring.boot3.SynologyDsmAutoConfiguration"));
    }
